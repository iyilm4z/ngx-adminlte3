...
import { NgxLTE3LayoutConfig, LayoutOptions } from './layout.config';

/*
 *
 */
export class NgxLTE3LayoutStore {
    public readonly layoutConfig: Observable<NgxLTE3LayoutConfig>;

    // tslint:disable-next-line:variable-name
    private _layoutConfig: BehaviorSubject<NgxLTE3LayoutConfig>;
    private readonly initialLayoutConfig: NgxLTE3LayoutConfig = {
        logo: '',
        appName: 'Appication',
     ...
     */
    constructor(layoutConfig: NgxLTE3LayoutConfig) {
        if (layoutConfig) {
