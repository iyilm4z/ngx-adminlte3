...
@Component({
    selector: 'ngxlte3-layout-wrapper',
    templateUrl: './wrapper.component.html'
})
export class NgxLTE3WrapperComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.subscriptions.push(this.ngxLTE3LayoutStore.type.subscribe(layoutType => {
